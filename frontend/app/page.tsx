  ...
  return (
    <div className="min-h-[calc(100vh-5rem)] flex flex-col justify-center items-center">
      ...
      <div className="bg-[#FAF9F6] p-4 flex flex-row gap-3 rounded-md mt-8 shadow-md z-1">
        <button onClick={handleStart} className={`${isRunning ? 'text-[#770737]' : 'text-black'} cursor-pointer`}>
          <Play />
        </button>
        <button onClick={handlePause} className={`${!isRunning ? 'text-[#770737]' : 'text-black'} cursor-pointer`}>
          <Pause />
        </button>
